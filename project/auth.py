...
def admin():
    if request.method == 'POST':
        ...
        if len(customers) == 0:
            found = 0
        #return make_response(render_template('admin.html', user=current_user, customers=customers, found=found))
        return render_template('admin.html', user=current_user, customers=customers, found=found)
    else:
        return render_template('admin.html', user=current_user)
        # return make_response(render_template('admin.html', user=current_user))
...
def wire():
    if request.method == 'POST':
        ...
        # return make_response(render_template('wire.html', user=current_user))
        return render_template('wire.html', user=current_user)
    # return make_response(render_template('wire.html', user=current_user))
    return render_template('wire.html', user=current_user)
